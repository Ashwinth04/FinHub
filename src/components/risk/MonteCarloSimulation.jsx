...
export default function MonteCarloSimulation({ portfolioId, data, onRunSimulation }) {
  ...
  return (
    <div className="card">
      ...
      {!data && !isLoading && (
        <div className="h-[400px] flex items-center justify-center border-2 border-dashed border-neutral-300 dark:border-neutral-600 rounded-lg">
